...
const mockProducts: Product[] = [
  ...
  // T-Shirt variants for testing
  {
    ...
    sku: "CLO-001-RED",
    description: "Premium cotton T-Shirt in Red",
    minStock: 5,
    maxStock: 50,
    unit: "piece",
    supplier: "Fashion Supplies Co.",
    brand: "ComfortWear",
    isFeatured: true,
    isNew: false,
    createdAt: new Date(),
  ...
  },
  {
    ...
    sku: "CLO-001-BLUE",
    description: "Premium cotton T-Shirt in Blue",
    minStock: 5,
    maxStock: 50,
    unit: "piece",
    supplier: "Fashion Supplies Co.",
  ...
  },
  {
    ...
    sku: "CLO-001-GREEN",
    description: "Premium cotton T-Shirt in Green",
    minStock: 5,
    maxStock: 50,
    unit: "piece",
    supplier: "Fashion Supplies Co.",
  ...
  // Coffee size variants
  {
    ...
    sku: "COF-002-S",
    description: "Premium Arabica coffee blend - Small size",
    minStock: 10,
    maxStock: 100,
    unit: "cup",
  ...
  },
  {
    ...
    sku: "COF-002-M",
    description: "Premium Arabica coffee blend - Medium size",
    minStock: 10,
    maxStock: 100,
    unit: "cup",
    supplier: "Coffee Supplies Co.",
  ...
  },
  {
    ...
    sku: "COF-002-L",
    description: "Premium Arabica coffee blend - Large size",
    minStock: 10,
    maxStock: 100,
    unit: "cup",
    supplier: "Coffee Supplies Co.",
...
const mockCategories: Category[] = [
  ...
  { id: "8", name: "Clothing", description: "Clothing and apparel", icon: "👕", parentId: undefined, isActive: true, order: 8 }
]
